...
while (fecha != "ESC") {
    ...
    if (fecha == 2015) {
        alert(`Con una participación ciudadana de ${procesoElectoral2015.calcParticipacion()}% en la elección federal de ${fecha}, el costo de cada voto fue de ${procesoElectoral2015.calcCostoVoto()} pesos. `);
        fecha = prompt("Ingresa el año de la elección federal en México:\n\n Opciones válidas: 2015 - 2018 - 2021");
    }
    else if (fecha == 2018) {
        alert(`Con una participación ciudadana de ${procesoElectoral2018.calcParticipacion()}% en la elección federal de ${fecha}, el costo de cada voto fue de ${procesoElectoral2018.calcCostoVoto()} pesos. `);
        fecha = prompt("Ingresa el año de la elección federal en México:\n\n Opciones válidas: 2015 - 2018 - 2021");
    }
    else if (fecha == 2021) {
        alert(`Con una participación ciudadana de ${procesoElectoral2021.calcParticipacion()}% en la elección federal de ${fecha}, el costo de cada voto fue de ${procesoElectoral2021.calcCostoVoto()} pesos. `);
        fecha = prompt("Ingresa el año de la elección federal en México:\n\n Opciones válidas: 2015 - 2018 - 2021");
    }
    else {
