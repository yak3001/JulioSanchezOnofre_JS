...
$('#submit').on('click', (event) => {
    ...
    <br><img src="./media/voto-back.png" alt="voto" id="img-calculo"></p><br><button class="btn btn-secondary" type="reset" onclick="window.location.reload()" data-bs-dismiss="offcanvas">Cerrar</button></div>`);
}
)
